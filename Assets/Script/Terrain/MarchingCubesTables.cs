...
/// <summary>
/// Стандартные таблицы Marching Cubes (Paul Bourke, "Polygonising a scalar field").
/// </summary>
public static class MarchingCubesTables
{
    /// <summary>Смещения 8 углов куба относительно минимального угла ячейки.</summary>
    ...
    /// <summary>Первый угол каждого из 12 рёбер куба.</summary>
    public static readonly int[] EdgeCornerA = { 0, 1, 2, 3, 4, 5, 6, 7, 0, 1, 2, 3 };

    /// <summary>Второй угол каждого из 12 рёбер куба.</summary>
    public static readonly int[] EdgeCornerB = { 1, 2, 3, 0, 5, 6, 7, 4, 4, 5, 6, 7 };

    /// <summary>
    /// Для каждой из 256 конфигураций — список рёбер, по три на треугольник.
    /// </summary>
